...
async def get_settings(current_user: UserResponse = Depends(get_admin_user)):
    ...
    try:
        ...
        backend_descriptions = {
            ...
            "PORT": "Server port",
            "FRONTEND_URL": "Frontend URL (also used for CORS)",
            "JWT_SECRET_KEY": "JWT signing secret key",
            "JWT_ALGORITHM": "JWT signing algorithm",
            "JWT_EXPIRE_MINUTES": "JWT expiration time (minutes)",
            "ADMIN_EMAIL": "Admin account email",
            "ADMIN_PASSWORD": "Admin account password",
            "APP_AI_BASE_URL": "Local AI endpoint (self-hosted Ollama, OpenAI-compatible)",
            "APP_AI_KEY": "Local AI endpoint key (Ollama ignores the value)",
        }
