...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'ResQKit';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'Emergency first aid guidance app';
